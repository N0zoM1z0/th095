...
supplies 1,830 provisional function candidates. Eighty canonical units now
reproduce 72,899 authored bytes exactly, including the complete 17,018-byte
...
target-local audit has now admitted 57,014 additional bytes
from the photography/camera, replay/menu, and gameplay/resource clusters, so
exact coverage is 58.21% of the expanded 125,233-byte authored set. The global
