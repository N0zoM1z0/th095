...
supplies 1,830 provisional function candidates. Fifty-nine canonical units
now reproduce 65,676 authored bytes exactly, including the complete 17,018-byte
...
runtime family. That is 98.02% of the currently confirmed 67,002-byte
