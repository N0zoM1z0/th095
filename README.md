...
supplies 1,830 provisional function candidates. Seventy-one canonical units
now reproduce 71,361 authored bytes exactly, including the complete 17,018-byte
...
runtime family. A target-local audit has now admitted 55,476 additional bytes
from the photography/camera, replay/menu, and gameplay/resource clusters, so
exact coverage is 57.69% of the expanded 123,695-byte authored set. The global
