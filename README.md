...
supplies 1,830 provisional function candidates. Sixty-nine canonical units
now reproduce 71,039 authored bytes exactly, including the complete 17,018-byte
...
exact coverage is 57.58% of the expanded 123,373-byte authored set. The global
