...
supplies 1,830 provisional function candidates. Sixty-seven canonical units
now reproduce 69,264 authored bytes exactly, including the complete 17,018-byte
...
exact coverage is 57.17% of the expanded 121,154-byte authored set. The global
