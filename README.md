...
supplies 1,830 provisional function candidates. Sixty-eight canonical units
now reproduce 70,057 authored bytes exactly, including the complete 17,018-byte
...
exact coverage is 56.78% of the expanded 123,373-byte authored set. The global
