...
- `EclManager::RunEcl` at `0x00408E70` is exact for its complete 27,091-byte
  ...
  relocations. Confirmed authored-byte coverage is now 53.85% (89,909 / 166,954)
...
- A target-local boundary and call-graph audit has promoted 32 additional
  ...
  confirms 170 authored candidates and leaves 1,660 origin/boundary reviews
...
complete 275-call topology, and its 136-byte texture clear is exact. Continue
with `LoadSceneSelectionAssets @ 0x0044D0A0`, then the mapped texture upload
and scene-label dependencies. Prefer dependency-rich target-specific state
