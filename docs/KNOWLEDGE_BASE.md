...
| MATCH-006 | exact | Eleven canonical ReplayManager units reproduce 2,660 authored bytes and all 109 relocations, covering initialization, lifetime, allocation, chain integration, loading, per-frame stream processing, and playback FPS output. | Pinned VC7.1 relocation replay for every listed ReplayManager unit |
