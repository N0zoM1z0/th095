...
| `0x004020C0..0x00402E90` | 2,149 exact authored bytes | Background construction, lifecycle callbacks, loader, VM updater | eight exact / two source-present Background functions | Constructor proves timer arrays, eleven inline ANM VMs and the 0x201C target owner before stage/camera runtime |
