...
| `0x0041E9C0..0x004200F6` | 1,910 exact authored bytes | concrete photograph-cut laser collision lane | exact straight collision / rotating one-byte residual | 12-unit beam sampling, capture particles, gap trimming, fragment spawning, target var-order and x87 scaling ownership |
