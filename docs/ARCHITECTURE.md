...
| `0x00436760..0x0043778F` | 2,513 exact authored bytes | ScreenEffect fade/pulse/shake runtime | fourteen exact ScreenEffect functions | D3D clear/viewport, fade-in/out/hold, pulse repeats, photography-gated linear/envelope shake, lifecycle callbacks |
