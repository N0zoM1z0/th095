...
arrays occupy the next 6,720 bytes.  `c_dfDIJoystick2 @ 0x00497EEC` has
...
### 2026-09-07: immediate-pointer boundary audit and corrected credit

See `docs/BOUNDARY_AUDIT.md` and `scripts/audit-authored-boundary.py`. This
...
best-shot reset now credits its complete return instruction. Current credit
is 693/697 functions and 333,284/339,148 bytes. No hard residual was promoted.
Ninety-three units across Main, ResultScreen, AnmManager, and Controller were
