...
C_ASSERT(offsetof(Enemy, vm) == 0x8);
C_ASSERT(offsetof(Enemy, anmHandles) == 0x2d4);
C_ASSERT(offsetof(Enemy, mainEclContextStorage) == 0x2dc);
C_ASSERT(offsetof(Enemy, mainEclCallStackStorage) == 0x50c);
C_ASSERT(offsetof(Enemy, activeEclContext) == 0x280c);
C_ASSERT(offsetof(Enemy, activeEclCallStack) == 0x2810);
C_ASSERT(offsetof(Enemy, eclIntVariables) == 0x2814);
C_ASSERT(offsetof(Enemy, eclFloatVariables) == 0x2834);
C_ASSERT(offsetof(Enemy, mainEclCallStackDepth) == 0x2854);
C_ASSERT(offsetof(Enemy, activeEclCallStackDepth) == 0x2856);
C_ASSERT(offsetof(Enemy, pendingEclSubroutineIndex) == 0x289c);
C_ASSERT(offsetof(Enemy, position) == 0x28a0);
C_ASSERT(offsetof(Enemy, positionOffset) == 0x28ac);
C_ASSERT(offsetof(Enemy, velocity) == 0x28b8);
C_ASSERT(offsetof(Enemy, worldPosition) == 0x28f4);
C_ASSERT(offsetof(Enemy, life) == 0x2968);
